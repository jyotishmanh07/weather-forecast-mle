...
from steps.data_splitter import data_splitter  # New Import
...
def news_integrity_unified_pipeline():
    ...
    train_df, test_df = data_splitter(cleaned_df)

    model_uri = train_model(train_df) 
    deployment_decision = evaluate_model(test_df, model_uri)
